...
public class FileClient {
	...
	public FileClient(String filename) throws NamingException, JMSException {
		...
		System.out.println("TextMessage:  " + request.getText());
		mMessageProducer.send(request); //send message
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("FileClient = null");
		try {
			client = new FileClient(args[0]);
			System.out.println("new FileClient with args[0] -> filename = " + args[0]);
